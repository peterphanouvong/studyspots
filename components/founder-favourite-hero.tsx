...
export function FounderFavouriteHero() {
  return (
    <div className="flex items-center flex-col sm:flex-row sm:justify-between gap-1.5 p-4 sm:border rounded-2xl">
      ...
      <p className="max-w-[180px] text-center sm:text-right text-md font-medium leading-tight">
        One of my favourite spots to study
      </p>
    </div>
  );
}
